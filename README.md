local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	local PresetColor = Color3.fromRGB(0, 128, 255)
	...
	function create:Win(text)
		...
		NameReal.TextColor3 = Color3.fromRGB(0,128,255)
		...
		--  imagenoti.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=7578496318&width=0&height=0&format=png"
			...
			txdlid.BackgroundColor3 = Color3.fromRGB(0,128,255)
			txdlid.Size =UDim2.new(0, 160, 0,25 )
			txdlid.Font = Enum.Font.GothamBold
			txdlid.Text = titel
			txdlid.TextColor3 = Color3.fromRGB(0,128,255)
			...
			LableFrame.BackgroundColor3 = Color3.fromRGB(0,128,255)
			...
			TextNoti.BackgroundColor3 = Color3.fromRGB(0,128,255)
	...
	--Time.AnchorPoint = Vector2.new(0.5, 0.5)
			Time.BackgroundColor3 =  Color3.fromRGB(0,128,255)
		...
		function top:Taps(text)
			...
			TextLabel_Tap.BackgroundColor3 = Color3.fromRGB(0,128,255)
			...
			ScrollingFrame_Pagefrist.ScrollBarImageColor3 = Color3.fromRGB(0,128,255) -- 0,128,255
		...
		--        TextButton_2_Toggle.BorderColor3 = Color3.fromRGB(0,128,255)
		...
		--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(0,128,255)
		...
		TextButton_Toggle2.MouseButton1Click:Connect(function()
				if check.toogle == false and check.loacker == true  then
					TweenService:Create(
						...
						{BackgroundColor3 =  Color3.fromRGB(0,128,255)} -- UDim2.new(0, 128, 0, 25)
					):Play()
					TweenService:Create(
						TextButton_3_Toggle,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function items:Button(text,callback)
				...
				ButtonFrame.BackgroundColor3 = Color3.fromRGB(0,128,255)
				...
				MheeFrameStroke.Color = Color3.fromRGB(0,128,255)
			...
			if check then
				...
				SliderFrame.BackgroundColor3 =  Color3.fromRGB(28, 28, 28)-- Color3.fromRGB(0,128,255)
				...
				SliderFrameStroke.Color = Color3.fromRGB(0,128,255)
				...
				MainValue.BackgroundColor3 = Color3.fromRGB(0,128,255)
		...
		--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(0,128,255)
			...
			if use == false then
				...
				DropFrame.BackgroundColor3 =  Color3.fromRGB(23, 23, 23)-- Color3.fromRGB(0,128,255)
				...
				DropFrameStroke.Color = Color3.fromRGB(0,128,255)
				...
				LabelFrameDrop.BackgroundColor3 = Color3.fromRGB(0,128,255)
			...
			--   LabelFrameDrop.AnchorPoint = Vector2.new(0.5, 0.5)
				...
				TextLabel_TapDrop.BackgroundColor3 = Color3.fromRGB(0,128,255)
		...
		--     TextLabel_TapDrop.AnchorPoint = Vector2.new(0.5, 0.5)
				...
				ButtonDrop.BackgroundColor3 = Color3.fromRGB(0,128,255)
			...
			--   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
				...
				for i , v in pairs(option) do
					...
					ListFrame.BackgroundColor3 =  Color3.fromRGB(22553, 23, 23)-- Color3.fromRGB(0,128,255)
					...
					TextLabel_TapDro2p.BackgroundColor3 = Color3.fromRGB(0,128,255)
					...
					ButtonDrop2.BackgroundColor3 = Color3.fromRGB(0,128,255)
	...
	--     TextLabel_TapDrop.AnchorPoint = Vector2.new(0.5, 0.5)
		...
		--   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
			...
			for i , v in pairs(list) do
				...
				farmtoglist.BackgroundColor3 = Color3.fromRGB(0,128,255)
				farmtoglist.BorderColor3 = Color3.fromRGB(0,128,255)
				...
				farmtoglist2.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	ScolDown.CanvasSize = UDim2.new(0,0,0,UIListLayoutlist.AbsoluteContentSize.Y + 10  )
			...
			function items:TextBox(text,text2,callback)
				...
				TextFrame2.BackgroundColor3 = Color3.fromRGB(0,128,255)
				...
				TextBoxStroke.Color = Color3.fromRGB(0,128,255)
			...
			function items:Bind(text,bi,callback)
				...
				BindStroke.Color = Color3.fromRGB(0,128,255)
			...
			function items:Line()
				...
				LineFrame.BackgroundColor3 =  Color3.fromRGB(0,128,255)
	...
	--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(0,128,255)
			...
			TextButton_3_Toggle2.BorderColor3 = Color3.fromRGB(0,128,255)
			...
			BTN_XD.BackgroundColor3 = Color3.fromRGB(0,128,255)
			BTN_XD.BorderColor3 = Color3.fromRGB(0,128,255)
		...
		OMF.MouseButton1Down:Connect(
			...
			function items:Label(text,image)
				...
				LabelStroke.Color = Color3.fromRGB(0,128,255)
